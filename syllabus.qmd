...
gt::gt(tibble::tibble(
  ...
  `Lecture (M/W/F)` = c(rep("10am - 10:50am", 3), rep("11am - 11:50am", 3)),
  `Lab (Th)` = c(rep(
    c("9am - 10:20am", "10:30am - 11:50am", "1:40pm - 3pm"), 2
  ))
))
```
